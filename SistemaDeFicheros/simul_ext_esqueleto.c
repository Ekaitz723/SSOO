...
//OBJETIVO: Muestra el contenido del fichero especificado como un texto. Deberá comprobar que el
//fichero existe. Si el fichero ocupa más de un bloque, debe aparecer en el orden
//correcto.
